@echo off
REM PyPSA GESI Rolling Horizon 분석 실행 (CPLEX 사용)
REM 
REM 이 스크립트는 conda 환경에서 Rolling Horizon 분석을 실행합니다.

echo ======================================================================
echo PyPSA GESI Rolling Horizon 분석 (CPLEX)
echo ======================================================================
echo.
...
echo [옵션] --rolling-horizon --segments 12
echo.

REM Rolling Horizon 분석 실행 (12개 구간, 기본 설정)
"%CONDA_PYTHON%" PyPSA_GUI.py --rolling-horizon --segments 12
